...
class SixthPaymentInInstallmentsDAO
{
    ...
    {
        try {
            $sql = "UPDATE tbl_sixth_installment SET
    ...
    public function listOpenInstallment() {
        try {
            ...
            $sql = "SELECT * FROM tbl_sixth_installment WHERE installment_status = 'Em Aberto' AND installment_date <= '$currentDate' ORDER BY idclient ASC";
