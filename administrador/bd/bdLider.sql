...
--
-- Host: localhost
-- Tempo de geração: 28/09/2023 às 20:11
...
--
-- Estrutura para tabela `adminTable`
--
...
--
-- Despejando dados para a tabela `adminTable`
--

INSERT INTO `adminTable` (`id`, `name`, `email`, `password`, `registrationDate`) VALUES
...
(21, 'mateus', 'm@gmail.com', '$2y$10$DtqzT6Ikjy2Abhl5dmb/gOoK8ZsxM/FHzOSpSSx8bC6uVVGrLRI1S', '2023-09-13'),
(22, 'sophia', 's@gmail.com', '$2y$10$McOBL4kHrTHpqIlEF0lW..KxjA67GBfBE.pGCUNC/8qAftnS1s9qu', '2023-09-17');
...
--
-- AUTO_INCREMENT de tabela `adminTable`
--
ALTER TABLE `adminTable`
