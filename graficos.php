...
<body>
    ...
    <nav class="card mt-0">
        <div class="container d-flex">
            ...
            <a href="graficos.php#aprovados-reprovados" class="card-link">Alunos aprovados e reprovados</a>
        </div>
    </nav>
    ...
    <div class="container">
        <div class="row">
            ...
            <p id="aprovados-reprovados" class="fs-2 text-center mt-5">Alunos aprovados e reprovados</p>
